...
# ── FALLBACK ÜRÜN HAVUZU — Kategoriye uygun görseller ─────
FALLBACK = [
    # ACTION FIGURES
    {"title":"Marvel Spider-Man Bend And Flex Action Figure",
     "price":"$9.99","category":"Action Figures","age_group":"6-9",
     "image_url":"https://images.unsplash.com/photo-1608889175123-8ee362201f81?q=80&w=600",
     "link":f"https://www.amazon.com/s?k=spiderman+action+figure&tag={AMAZON_TAG}"},
    {"title":"Transformers Optimus Prime Action Figure",
     "price":"$24.99","category":"Action Figures","age_group":"6-9",
     "image_url":"https://images.unsplash.com/photo-1566576912321-d58ddd7a6088?q=80&w=600",
     "link":f"https://www.amazon.com/s?k=transformers+optimus+prime+figure&tag={AMAZON_TAG}"},
    {"title":"Marvel Avengers Titan Hero Series 4-Pack",
     "price":"$44.99","category":"Action Figures","age_group":"6-9",
     "image_url":"https://images.unsplash.com/photo-1601987077677-5346c463575a?q=80&w=600",
    ...
    {"title":"Batman Dark Knight Poseable Action Figure",
     "price":"$19.99","category":"Action Figures","age_group":"6-9",
     "image_url":"https://images.unsplash.com/photo-1611532736597-de2d4265fba3?q=80&w=600",
     "link":f"https://www.amazon.com/s?k=batman+action+figure+kids&tag={AMAZON_TAG}"},
    # DINOSAURS
    {"title":"Dinosaur Figures Set — 12 Realistic Dinos",
     "price":"$24.99","category":"Dinosaurs","age_group":"3-5",
     "image_url":"https://images.unsplash.com/photo-1619566636858-adf3ef46400b?q=80&w=600",
    ...
    {"title":"T-Rex Roaring Electronic Dinosaur Toy",
     ...
     "image_url":"https://images.unsplash.com/photo-1584714268709-c3dd9c92b378?q=80&w=600",
    ...
    {"title":"Stegosaurus Large Realistic Dinosaur Figure",
     ...
     "image_url":"https://images.unsplash.com/photo-1535083783855-aaab5f24c4de?q=80&w=600",
    ...
    {"title":"Velociraptor Dinosaur with Sound Effects",
     ...
     "image_url":"https://images.unsplash.com/photo-1606921231106-f1083329a65c?q=80&w=600",
     "link":f"https://www.amazon.com/s?k=velociraptor+dinosaur+sound+toy&tag={AMAZON_TAG}"},
    {"title":"Dinosaur Eggs Surprise Excavation Kit",
     "price":"$19.99","category":"Dinosaurs","age_group":"6-9",
     "image_url":"https://images.unsplash.com/photo-1562155618-e1a8c9b399c3?q=80&w=600",
     "link":f"https://www.amazon.com/s?k=dinosaur+egg+excavation+kit&tag={AMAZON_TAG}"},
    # PLAYSETS
    {"title":"LEGO City Police Station Building Set",
     "price":"$59.99","category":"Playsets","age_group":"6-9",
     "image_url":"https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?q=80&w=600",
     "link":f"https://www.amazon.com/s?k=lego+city+police+station&tag={AMAZON_TAG}"},
    {"title":"Jurassic World Dinosaur Escape Playset",
     "price":"$64.99","category":"Playsets","age_group":"6-9",
     "image_url":"https://images.unsplash.com/photo-1596461404969-9ae021eca1f0?q=80&w=600",
     "link":f"https://www.amazon.com/s?k=jurassic+world+dominion+playset&tag={AMAZON_TAG}"},
    {"title":"Castle Adventure Playset with Knights",
     "price":"$44.99","category":"Playsets","age_group":"6-9",
     "image_url":"https://images.unsplash.com/photo-1575783970733-1aaedde1db74?q=80&w=600",
     "link":f"https://www.amazon.com/s?k=castle+playset+kids+knights&tag={AMAZON_TAG}"},
    {"title":"Peppa Pig Family Home Playset",
     "price":"$39.99","category":"Playsets","age_group":"3-5",
     "image_url":"https://images.unsplash.com/photo-1594736797933-d0501ba2fe65?q=80&w=600",
    ...
    {"title":"Hot Wheels 20-Car Gift Pack",
     ...
     "image_url":"https://images.unsplash.com/photo-1581833971358-2c8b550f87b3?q=80&w=600",
    ...
    {"title":"Remote Control Monster Truck Off Road",
     ...
     "image_url":"https://images.unsplash.com/photo-1563861826100-9cb868fdbe1c?q=80&w=600",
    ...
    {"title":"National Geographic Dinosaur Dig Kit",
     ...
     "image_url":"https://images.unsplash.com/photo-1503676260728-1c00da094a0b?q=80&w=600",
    ...
    {"title":"Magnetic Tiles Building Blocks 100pc",
     ...
     "image_url":"https://images.unsplash.com/photo-1560785496-3c9d27877182?q=80&w=600",
    ...
    {"title":"Kids Science Lab Experiment Kit",
     "price":"$29.99","category":"Educational","age_group":"6-9",
     "image_url":"https://images.unsplash.com/photo-1513364776144-60967b0f800f?q=80&w=600",
     "link":f"https://www.amazon.com/s?k=kids+science+lab+experiment+kit&tag={AMAZON_TAG}"},
    # FANTASY
    {"title":"Dragon Fire Fantasy Creature Figure",
     "price":"$29.99","category":"Fantasy","age_group":"10+",
     "image_url":"https://images.unsplash.com/photo-1604514628550-37477afdf4e3?q=80&w=600",
    ...
    {"title":"Unicorn Kingdom Magical Playset",
     ...
     "image_url":"https://images.unsplash.com/photo-1615751072497-5f5169febe17?q=80&w=600",
    ...
    {"title":"Phoenix Mythical Creature Figure Set",
     ...
     "image_url":"https://images.unsplash.com/photo-1559827260-dc66d52bef19?q=80&w=600",
    ...
    {"title":"Safari Ltd Farm Animal Figure Set 20pc",
     ...
     "image_url":"https://images.unsplash.com/photo-1474511320723-9a56873867b5?q=80&w=600",
    ...
    {"title":"Toddler Pull-Along Wooden Animal Toy",
     ...
     "image_url":"https://images.unsplash.com/photo-1518791841217-8f162f1912da?q=80&w=600",
    ...
    {"title":"Wild Animal Kingdom Figure Collection",
     ...
     "image_url":"https://images.unsplash.com/photo-1564349683136-77e08dba1ef7?q=80&w=600",
